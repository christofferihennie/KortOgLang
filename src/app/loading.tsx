...
export default function Loading() {
    return (
        <>
            ...
            <h3 className='scroll-m-20 text-2xl font-semibold tracking-tight'>Dine aktive spill</h3>
            ...
            <h3 className='scroll-m-20 text-2xl font-semibold tracking-tight'>Dine siste spill</h3>
