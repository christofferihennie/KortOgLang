        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Denne handlingen kan ikke angres. Dette vil permanent avslutte spillet og
                        fjerdig gjøre resultatet.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    <AlertDialogCancel>Fortsett spillet</AlertDialogCancel>
                    <AlertDialogAction onClick={finishGame}>Avslutt spillet</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
    );
